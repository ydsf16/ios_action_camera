...
- Build 26 also renames the remaining internal C API abbreviations to roamshot_engine_ and RoamShot type names; iOS archive, simulator build, binary string and linkage audits passed.
