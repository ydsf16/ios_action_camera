...
bench_dir="$(mktemp -d /tmp/roamshot-export.XXXXXX)"
...
xcrun swiftc -O -D DEBUG -parse-as-library -import-objc-header Engine/include/RoamShotGyroflow.h \
    Sources/CaptureCore/*.swift App/Stabilization/MetalStabilizer.swift App/Stabilization/StabilizationProcessor.swift \
    scripts/ExportBenchmark.swift scripts/MetalPixelValidation.swift scripts/OrientationValidation.swift scripts/StabilizationParameterValidation.swift scripts/HorizonPixelValidation.swift scripts/AdaptiveStabilizationValidation.swift "Engine/target/$bench_target/release/libroamshot_gyroflow.a" \
